...
<div class="div" style="background-color:#84C7F9; height: 100%;">
      ...
      <div class="row">
        <div class="col-md-6 w" style="margin-top: 5%;">
          <div class="search">
            <div class="inputContainer">
              <input type="text" id="searchName" class="searchTerm" placeholder="Search..." style="border-radius: 20px; border: 2px solid #294D8B; box-shadow: 0 0.125rem 0.3125rem rgba(41, 77, 139, 1);">
              <button @click="get()"><i  class="fa fa-search searchIcon" id="searchIcon"></i></button>
            </div>
          </div>
        ...
        <div class="col-md-3 col-sm-5" style="margin-top: 8%;">
          <div class="form-check">
            ...
            <label class="form-check-label" for="flexCheckDefault" style="color: #1E56A0; font-weight: bold;">Store Drugs</label>
          </div>
        </div>
        <div class="col-md-3 col-sm-5" style="margin-top: 8%;">
          <div class="form-check">
    ...
    <div class="row" style="margin-top: 5%;">
      <div class="container1" style="justify-content: center; background-color: #ffff;">
        <div class="flex-container">
          ...
          <span style="color: #294D8B; font-weight: bolder; font-size: x-large;">Stores</span>
        </div>
      </div>
    </div>
    ...
    <div v-for="drug in storeDrugs" class="row row-cols-1  g-4 row-cols-md-4 flex-wrap" style="margin-top: 0%;">
    <!-- first col -->
    <div  class="col">
    ...
    <div v-for="drug in pharmacyDrugsDrugs" class="row row-cols-1  g-4 row-cols-md-4" style="margin-top: 0%;">
    <!-- first col -->
    <div class="col">
...
<script setup>
    ...
    let search = "";
      ...
      try {
      const response2 = await axios.get(`http://127.0.0.1:8000/api/stores/drugs/${search}`);
      const storeDrugs = response2.data;
      if(storeDrugs != {}){
      console.log(storeDrugs);}
    }
      catch{
