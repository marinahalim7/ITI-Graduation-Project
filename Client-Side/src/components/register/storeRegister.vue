...
let submit=async (event)=>{
  ...
  if (validDate.value){
    ...
    try {
      const pharmacy=await axios.post("http://127.0.0.1:8000/api/store",formData);
      console.log("added");
      ...
      <div class="row mt-5">
        ...
        <div class="col-6">
          <div class="form-floating">
            ...
            <label for="name" class="fw-bold normal-words w-100"><i class="fa-solid fa-window-restore mx-3 fs-5"></i>Store Name</label>
          </div>
          <span class="text-danger fw-bold" v-show="pharmacyName==''">Store Name is required</span>
        </div>
      </div>
